...
pasaporte<-"CubaMaizTotal147.txt"
#Parametro de tipo texto (un texto que va entre comillas "")
...
buffy<-TRUE #Solo aplica cuando ecogeo=TRUE
#Parametro tipo TRUE o FALSE
...
edaphv<-c("Organic carbon dens top","Silt content top","Sand content top","Clay content top","Avail soil water cap top","Soil pH H2O top","Sodic soil grade") #Solo aplica si bioclimsn=TRUE
...
ecogeopcaxe<-10 #Solo aplica para ecogeopca=TRUE
#Parametro tipo numero (el cual en Rstudio aparecera con color azul)
...
phenopcaxe<-10 #Solo aplica para phenopca=TRUE
#Parametro tipo numero (el cual en Rstudio aparecera con color azul)
...
genoclus<-FALSE #Solo aplica para genotip=TRUE
#Parametro tipo TRUE o FALSE
...
#Resultados
#############################################
resultados<-"C:/CasoCuba/DIVmapas"
#Parametro de tipo texto (un texto que va entre comillas "")
