...
geophysv<-c("Elevacion","Pendiente grados","Velocidad viento 1","Velocidad viento 7","Velocidad viento anual","Radiacion solar 1","Radiacion solar 7","Radiacion solar anual")
...
#Results
#############################################
resultados<-"C:/CAPFITOGEN3/Results/Melothria/SelecVar"
#Text type parameter (text that goes between quotation marks "")
