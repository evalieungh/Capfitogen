...
library(maptools)
library(rgdal)
#library(ncdf) #este paquete se tendria que actualizar a ncdf4 en caso de usar una version de R de 2020
library(vegan)
library(mclust)
...
if(transfer){
  ...
  if(length(catactual2)==0){
    ...
    writeOGR(shapefile2,dsn=paste(resultados2),layer="MapTransferZone",driver="ESRI Shapefile")
  }
}
