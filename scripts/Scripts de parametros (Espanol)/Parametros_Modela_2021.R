##############################################
#Script de parametros Modela 2021
##############################################
...
#Modela solo tiene dos parametros a completar en Rstudio. El restro de los parametros se rellenan en una tabla excel, que al estar lista se salva como un archivo de texto (txt) el cual se debe ubicar en la ruta X:/CAPFITOGEN/ModelOptions, cuyo nombre se debe definir en el parametro partablename
ruta<-"C:/CAPFITOGEN3"
...
partablename<-"TableParametersExample.txt"
#Parametro de tipo texto (un texto que va entre comillas "")
#### Nota: este nombre corresponde al nombre de la tabla (incluyendo la extension .txt) en formato de texto, que contiene todos los parametros que configuran la herramienta Modela