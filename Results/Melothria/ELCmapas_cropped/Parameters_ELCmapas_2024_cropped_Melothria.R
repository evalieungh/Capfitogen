...
bioclimv<-c("Temp prom cuarto mas frio","Prec mes mas seco","Prec cuarto mas seco","Prec cuarto mas frio") #Only applies if bioclimsn=TRUE
...
edaphv<-c("Bulk density top","Cation exchange cap top","Organic carbon dens top","Soil pH H2O top") #Only applies if bioclimsn=TRUE
...
#Results
#############################################
resultados<-"C:/CAPFITOGEN3/Results/Melothria/ELCmapas_cropped"
#Text type parameter (text that goes between quotation marks "")
