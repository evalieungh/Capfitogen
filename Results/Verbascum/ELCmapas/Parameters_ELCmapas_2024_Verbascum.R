...
bioclimv<-c("Prec anual","Prec mes mas humedo","Prec cuarto mas humedo","Prec cuarto mas calido") #Only applies if bioclimsn=TRUE
...
edaphv<-c("Avail soil water cap h2 top","Organic carbon stock top","Organic carbon content top","Avail soil water cap top") #Only applies if bioclimsn=TRUE
...
geophysv<-c("Elevacion","Velocidad viento anual","Radiacion solar anual")
...
#geophysv<-c("Elevacion","Orientacion","Esticidad","Norticidad","Pendiente grados","Velocidad viento 1","Velocidad viento 2","Velocidad viento 3","Velocidad viento 4","Velocidad viento 5","Velocidad viento 6","Velocidad viento 7","Velocidad viento 8","Velocidad viento 9","Velocidad viento 10","Velocidad viento 11","Velocidad viento 12","Velocidad viento anual","Radiacion solar 1","Radiacion solar 2","Radiacion solar 3","Radiacion solar 4","Radiacion solar 5","Radiacion solar 6","Radiacion solar 7","Radiacion solar 8","Radiacion solar 9","Radiacion solar 10","Radiacion solar 11","Radiacion solar 12","Radiacion solar anual")
###Text type parameter (text that goes between quotation marks ""), of multiple type (you can select more than one option, including all the options in quotation marks, separated by commas and everything within a pair of parentheses preceded by the letter c)
...
#Results
#############################################
resultados<-"C:/CAPFITOGEN3/Results/Verbascum/ELCmapas"
#Text type parameter (text that goes between quotation marks "")
